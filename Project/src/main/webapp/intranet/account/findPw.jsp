            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Find Your Password</h5>
                    <p class="text-center small">Enter your id & email to find</p>
                  </div>

                  <script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.js"></script>
				  <script type="text/javascript" src="<%=request.getContextPath()%>/intranet/account/loginVal.js"></script>
                  <form class="row g-3 needs-validation" novalidate action="loginProc.jsp" method="post" onSubmit="return writeSave()">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Back to Login? &nbsp; <a href="login.jsp">로그인</a></p>
                    </div>
                  </form>
