            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="loginbyEmailProc.jsp" method="post" onSubmit="return writeSave()">
                    ...
                    <div class="col-12">
                      ...
                      <p class="small mb-0">Forgot Password? &nbsp; <a href="findPw.jsp">비밀번호 찾기</a></p>
                      <p class="small mb-0">Log in by Id? &nbsp; <a href="loginbyEmail.jsp">아이디로 로그인</a></p>
                    </div>
                  </form>
