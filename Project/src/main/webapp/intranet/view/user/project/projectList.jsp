...
<%
	...
	ArrayList<ProjectBean> plists = pdao.getProjectbyCode(code);
...
%>
  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb" style="margin-top: 5px;">
          ...
          <li class="breadcrumb-item">부서별 보기</li>
  ...
  <button type="button" class="btn btn-primary" onClick="location.href='insertProject.jsp?code=<%=code %>'"><i class="bi bi-folder-plus"></i>&nbsp;&nbsp;프로젝트 추가</button>
  <br><br>
  <%}else{} %>
