...
<!-- deptList.jsp(추가) => deptInsert.jsp  -->
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Insert Department</h5>
              <!-- Insert Form -->
              <form action="deptInsertProc.jsp" method="post" onSubmit="return writeSave()">
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label">부서 코드</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="code" style="margin-bottom: 5px;" onkeydown="keyd()">
